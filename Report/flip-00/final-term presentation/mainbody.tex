...
\begin{figure}[htbp]
	...
	\includegraphics[scale=0.3]{Figures/1.eps}
...
\begin{figure}[htbp]
	...
	\includegraphics[scale=0.3]{Figures/2.eps}
...
\begin{figure}[htbp]
	...
	\includegraphics[scale=0.3]{Figures/3.eps}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.3]{Figures/4.eps}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.4]{Figures/5.eps}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.4]{Figures/6.eps}
...
\begin{figure}[h]\centering
	\includegraphics[scale=0.4]{Figures/7.eps}
	\caption{Marginal Histogram}
\end{figure}

\begin{figure}[h]\centering
	\includegraphics[scale=0.4]{Figures/8.eps}
	\caption{Binary Density Function}
\end{figure}

\begin{figure}[h]\centering
	%\graphicspath{{figures/}{mine/}}
	\includegraphics[scale=0.4]{Figures/9.eps}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[scale=0.3]{Figures/10.eps}
...
\begin{figure}[htbp]
	\centering
	%\graphicspath{{figures/}{mine/}}
	\includegraphics[scale=0.3]{Figures/11.eps}
